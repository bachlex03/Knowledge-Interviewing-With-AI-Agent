...
- Orchestrator Skill: `.gemini/skills/orchestrator/SKILL.md` (and `.agents/skills/orchestrator/SKILL.md`)
- Subagent Definitions: `.gemini/agents/*.md` (and `.agents/skills/*.md` or equivalents)
