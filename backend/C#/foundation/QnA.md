...
#### Q_LEVEL2_476: Distinguish IQueryable vs IEnumerable vs List<T>.

**Question:**
en: How do `IQueryable`, `IEnumerable`, and `List<T>` differ in C#?
vi: `IQueryable`, `IEnumerable`, `Array` and `List<T>` khác nhau như thế nào trong C#?

**Answer:**
en: ...
vi: ...

**DETAILS ->** ./backend/C#/foundation/Q_LEVEL2_476.md
**RESOURCES ->** ./backend/C#/resouces.md [#1]
